...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Collections.sort(list,(o1,o2) -> o1.getPrice()!=o2.getPrice()?Integer.compare(o1.getPrice(),o2.getPrice()):
                        o1.getUser().getCity().compareTo(o2.getUser().getCity()));

        System.out.println("Sort list by Order price increase and User City: "+list);

        Collections.sort(list, (o1,o2) -> o1.getItemName()!=o2.getItemName()?
        ...
        separateForCurrency(list).entrySet().stream().forEach(System.out::println);

        System.out.println("Separate Items for City: ");
        separateForCity(list).entrySet().stream().forEach(System.out::println);
    ...
    public static Map separateForCurrency(List<? extends Order> list){
        return list.stream()
                .collect(Collectors.groupingBy(o -> o.getCurrency()));
    }
    ...
    public  static boolean isContainLatsName(Set<? extends Order> set,String name ){
        return set.stream()
